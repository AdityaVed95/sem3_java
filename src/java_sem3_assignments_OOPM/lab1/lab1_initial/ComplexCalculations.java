...
public class ComplexCalculations // this is a true service and can be called from either cui or gui
{

    public double[] addition(double r1, double i1, double r2, double i2)
    {
    ...
    public double[] subtraction(double r1, double i1, double r2, double i2)
    {
    ...
    public double [] divide(double r1, double i1, double r2, double i2)
    {
